...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container">
    <a class="navbar-brand" href="#">ProgramName</a>
    ...
    <div class="collapse navbar-collapse" id="navbarsExample07">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="#">모드전환 <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">그룹추가</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" onclick="profile('addmem')">친구추가</a>
        </li>
		   <li class="nav-item">
          <a class="nav-link" onclick="test()">삭제</a>
        </li>
		<li class="nav-item">
          <a class="nav-link" onclick="profile('pro')">내프로필</a>
        </li>
      </ul>
      <form class="form-inline my-2 my-md-0">
                                <input type="text" id="myInput" onkeyup="myFunction()" class="form-control" placeholder="검색">
						<br>
		...
		<div class="col-lg-4 col-sm-6">
            ...
            <div class="card hovercard">
                ...
                <div class="bottom">
                    ...
                    <a class="btnround btn btn-warning btn-sm" rel="publisher" href="/profile">
