...
<div class="col-md-4 ">
    ...
    <div class="col-md-8 col-xl-8 chat" id="aaa">
					<div class="card">
						<div class="card-header msg_head" >
						
									<li class="nav-item dropdown" style=" list-style:none;">
    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-plus" aria-hidden="true"></i></a>
